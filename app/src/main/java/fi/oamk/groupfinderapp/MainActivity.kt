...
class Post(val contact: String, val date:String, val description: String, val time: String, val title: String, val key: String, val num_participants: String) : Serializable {
    constructor() : this("","","","","", "", "")
}